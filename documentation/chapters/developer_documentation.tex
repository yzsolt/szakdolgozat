...
\begin{figure}[!ht]
    ...
    \caption{A főciklus folyamatábrája}
\end{figure}
...
Mindezek segítségével valósidőben, mindössze két textúraolvasással kiszámolható a kép alapú megvilágításból származó sugárzás. Sőt, a két besugárzási kockatérképet (diffúz és spekuláris) és a BRDF lookup textúrát nem muszáj előre kiszámolni, dinamikus tükröződés megvalósításához kevesebb mintával menet közben is generálhatók. Az \(\mathbf{n} = \mathbf{v} = \mathbf{l}\) feltételezés azonban szemmel látható hibákat okoz: például sík felületeknél észrevehető, hogy a valóságban ,,megnyúlt'' tükröződések emiatt itt nem jelennek meg.

\begin{figure}[!ht]
    \centering
    \includegraphics[width=1.0\textwidth]{images/nvl_error.png}
    \caption{Felül a sugárkövetéses referencia, alul az eredmény az \(\mathbf{n} = \mathbf{v} = \mathbf{l}\) miatt megjelenő hibával~\cite{karis2013real}}
\end{figure}
...
\begin{center}
  ...
  \begin{tabulary}{\textwidth}{L | C || L}
    ...
    \hline
    Üres .obj fájl & \checkmark & \footnotesize{A tinyobjloader ilyenkor nem jelez hibát, egyszerűen nem jelenik meg semmi.} \\
    \hline
  \end{tabulary}
  ...
  \begin{tabulary}{\textwidth}{L | C || L}
    ...
    \hline
    Alakzat kirajzolásának ki/bekapcsolása & \checkmark & \footnotesize{A kapcsoló megfelelően működik.} \\
    \hline
  \end{tabulary}
...
\textit{Eredmény:} a megjelenítő által előállított kép szinte tökéletesen megegyezik a referenciával.
